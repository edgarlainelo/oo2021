...
public class Homework7Test {
  public static void main(String[] args) throws FileNotFoundException { 
    ...
    HangmanTest hangman; //hangman klass
    ...
    if (players.equals("1")) { //alustame loopi 
      ...
      hangman = new HangmanTest(words);
    } else {
      System.out.println("'Mängija 1' Sisestage täht:");
      word = keyboard.nextLine();
      hangman = new HangmanTest(word);
      System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    ...
    while (true) {
      ...
      if (hangman.printWordState()) {
        System.out.println("Võitsite :)");

        System.out.println(" +\"\"\"\"\"+ "); // siin on rõõmus nägu kuna mängija kaotas
        System.out.println("(| 0 0 |)");
        System.out.println(" |  ^  | ");
      ...
      if (hangman.isAnswer(keyboard.nextLine())) {
        ...
        System.out.println("Kahuks mitte, proovige veel kord:)");
      }
      ...
      //System.out.println("Tahate veel mängida? Jah, Ei");
      //answer = sc.next();

      
    }//while(answer.equals("Jah"));
